...
- 🌟 👤 [MiroKaku](https://github.com/MiroKaku) Starred [can1357/oh-my-pi](https://github.com/can1357/oh-my-pi)
  > ⌥  AI Coding agent for the terminal — hash-anchored edits, optimized tool harness, LSP, Python, brow...
- 🌟 👤 [MiroKaku](https://github.com/MiroKaku) Starred [LabGuy94/Diskjacker](https://github.com/LabGuy94/Diskjacker)
  > Hijacking Hyper-V at Runtime with DDMA
- 🌟 👤 [MiroKaku](https://github.com/MiroKaku) Starred [rjkaes/trueline-mcp](https://github.com/rjkaes/trueline-mcp)
  > Smarter reads, safer edits. An MCP plugin that cuts token usage and catches editing mistakes before ...
- 🌟 👤 [MiroKaku](https://github.com/MiroKaku) Starred [badlogic/pi-mono](https://github.com/badlogic/pi-mono)
...
- 🌟 👤 [zu1k](https://github.com/zu1k) Starred [TencentCloud/CubeSandbox](https://github.com/TencentCloud/CubeSandbox)
