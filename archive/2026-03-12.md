...
- 🌟 👤 [0xdea](https://github.com/0xdea) Starred [kbknapp/cargo-outdated](https://github.com/kbknapp/cargo-outdated)
...
- 🌟 👤 [MiroKaku](https://github.com/MiroKaku) Starred [Kaliiiiiiiiii-Vinyzu/patchright-python](https://github.com/Kaliiiiiiiiii-Vinyzu/patchright-python)
  > Undetected Python version of the Playwright testing and automation library. 
- 🌟 👤 [MiroKaku](https://github.com/MiroKaku) Starred [zhizhuodemao/android_proxy_mcp](https://github.com/zhizhuodemao/android_proxy_mcp)
  > 基于 MCP 的 Android 抓包服务，让 AI 助手通过自然语言分析网络请求。

### [MouriNaruto](https://github.com/MouriNaruto)
- 🌟 👤 [MouriNaruto](https://github.com/MouriNaruto) Starred [openai/openai-dotnet](https://github.com/openai/openai-dotnet)
  > The official .NET library for the OpenAI API
- 🌟 👤 [MouriNaruto](https://github.com/MouriNaruto) Starred [anthropics/anthropic-sdk-csharp](https://github.com/anthropics/anthropic-sdk-csharp)
...
- 🌟 👤 [gatieme](https://github.com/gatieme) Starred [Dimillian/CodexMonitor](https://github.com/Dimillian/CodexMonitor)
