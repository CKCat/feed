...
- 🌟 👤 [MiroKaku](https://github.com/MiroKaku) Starred [dotnet/XAMLStudio](https://github.com/dotnet/XAMLStudio)
  > XAML Studio is a rapid prototyping tool for WinUI-based XAML that can then be easily copied into Vis...

### [MouriNaruto](https://github.com/MouriNaruto)
- 🌟 👤 [MouriNaruto](https://github.com/MouriNaruto) Starred [tandasat/SimpleSvm](https://github.com/tandasat/SimpleSvm)
