...
- 🌟 👤 [evilbinary](https://github.com/evilbinary) Starred [china-qijizhifeng/agentic-harness-engineering](https://github.com/china-qijizhifeng/agentic-harness-engineering)
  > Official AHE code — Agentic Harness Engineering: observability-driven automatic evolution of coding-...
...
- 🌟 👤 [mustime](https://github.com/mustime) Starred [shenjianZ/DeviceDeck](https://github.com/shenjianZ/DeviceDeck)
  > A modern Android screen mirroring and device management workbench built with Tauri 2 and Rust. Light...
- 🌟 👤 [mustime](https://github.com/mustime) Starred [overducast/RiftByte](https://github.com/overducast/RiftByte)
  > Binary diff tool for PE (EXE/DLL) and ELF files. Compares two binaries, resolves virtual addresses, ...
- 🌟 👤 [mustime](https://github.com/mustime) Starred [wux1an/wxapkg](https://github.com/wux1an/wxapkg)
