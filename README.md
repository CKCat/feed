...
- 🌟 👤 [bet4it](https://github.com/bet4it) Starred [talkcody/talkcody](https://github.com/talkcody/talkcody)
  > TalkCody - Code is cheap, show me your talk.  🚀 Free Open Source AI Coding Agent.
- 🌟 👤 [bet4it](https://github.com/bet4it) Starred [athasdev/athas](https://github.com/athasdev/athas)
  > A lightweight, cross-platform code editor, built with Tauri (Rust and React) with Git support, AI ag...
- 🌟 👤 [bet4it](https://github.com/bet4it) Starred [Satty-org/Satty](https://github.com/Satty-org/Satty)
  > Satty - Modern Screenshot Annotation.
- 🌟 👤 [bet4it](https://github.com/bet4it) Starred [PixiEditor/PixiEditor](https://github.com/PixiEditor/PixiEditor)
  > PixiEditor is a Universal Editor for all your 2D needs
- 🌟 👤 [bet4it](https://github.com/bet4it) Starred [walles/px](https://github.com/walles/px)
  > ps, top and pstree for human beings
- 🌟 👤 [bet4it](https://github.com/bet4it) Starred [farion1231/cc-switch](https://github.com/farion1231/cc-switch)
  > A cross-platform desktop All-in-One assistant tool for Claude Code, Codex & Gemini CLI.
- 🌟 👤 [bet4it](https://github.com/bet4it) Starred [Yoo1tic/gcli-nexus](https://github.com/Yoo1tic/gcli-nexus)
  > High-performance Gemini CLI reverse proxy that talks to the raw Cloud Code Gemini endpoints while pr...
- 🌟 👤 [bet4it](https://github.com/bet4it) Starred [BloopAI/vibe-kanban](https://github.com/BloopAI/vibe-kanban)
  > Get 10X more out of Claude Code, Codex or any coding agent
- 🌟 👤 [bet4it](https://github.com/bet4it) Starred [Rabithua/Rote](https://github.com/Rabithua/Rote)
