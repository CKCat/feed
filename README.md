...
- 🌟 👤 [LLeavesG](https://github.com/LLeavesG) Starred [paradiseduo/appdecrypt](https://github.com/paradiseduo/appdecrypt)
  > appdecrypt is a tool to make decrypt application encrypted binaries on macOS when SIP-enabled  (macO...
...
- 🌟 👤 [veritas501](https://github.com/veritas501) Starred [atlas4381/qualcomm_avb_exploit_poc](https://github.com/atlas4381/qualcomm_avb_exploit_poc)
  > Unlocking qualcomm bootloader
- 🍴 👤 [veritas501](https://github.com/veritas501) Forked [oven-sh/bun](https://github.com/oven-sh/bun) to [veritas501/bun](https://github.com/veritas501/bun)
  > Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one
- 🌟 👤 [veritas501](https://github.com/veritas501) Starred [xpzouying/xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp)
  > MCP for xiaohongshu.com


---
*最后更新于 2026-04-23 21:42:01 UTC*
*历史记录保存在 `archive` 目录中。*
