...
- 🍴 👤 [0xeb](https://github.com/0xeb) Forked [KeServiceDescriptorTable/vulnerable-drivers](https://github.com/KeServiceDescriptorTable/vulnerable-drivers) to [lallouslab/vulnerable-drivers-ex](https://github.com/lallouslab/vulnerable-drivers-ex)
...
- 🌟 👤 [SsageParuders](https://github.com/SsageParuders) Starred [phuselab/pyVHR](https://github.com/phuselab/pyVHR)
  > Python framework for Virtual Heart Rate
- 🌟 👤 [SsageParuders](https://github.com/SsageParuders) Starred [xliucs/MTTS-CAN](https://github.com/xliucs/MTTS-CAN)
...
- 🌟 👤 [SsageParuders](https://github.com/SsageParuders) Starred [axelmierczuk/tenrec](https://github.com/axelmierczuk/tenrec)
...
- 🌟 👤 [bet4it](https://github.com/bet4it) Starred [vyrx-dev/symphony](https://github.com/vyrx-dev/symphony)
  >  a setup I wish already existed
- 🍴 👤 [bet4it](https://github.com/bet4it) Forked [binaricat/Netcatty](https://github.com/binaricat/Netcatty) to [bet4it/Netcatty](https://github.com/bet4it/Netcatty)
  > SSH workspace, SFTP, and terminals in one

### [crazyguitar](https://github.com/crazyguitar)
- 🌟 👤 [crazyguitar](https://github.com/crazyguitar) Starred [antirez/ds4](https://github.com/antirez/ds4)
  > DeepSeek 4 Flash local inference engine for Metal

### [divyam234](https://github.com/divyam234)
- 🌟 👤 [divyam234](https://github.com/divyam234) Starred [getsops/sops](https://github.com/getsops/sops)
  > Simple and flexible tool for managing secrets
- 🌟 👤 [divyam234](https://github.com/divyam234) Starred [pfassina/lazyvim-nix](https://github.com/pfassina/lazyvim-nix)
...
- 🌟 👤 [nzcv](https://github.com/nzcv) Starred [junkurihara/rust-rpxy](https://github.com/junkurihara/rust-rpxy)
  > A simple and ultrafast http reverse proxy serving multiple domain names and terminating TLS for http...

### [phodal](https://github.com/phodal)
- 🚀 👤 [phodal](https://github.com/phodal) Made [phodal/codex-goal-ida](https://github.com/phodal/codex-goal-ida) public
  > A Testing for /goal of Codex IDA
...
- 🍴 👤 [smx-smx](https://github.com/smx-smx) Forked [cirruslabs/cirrus-cli](https://github.com/cirruslabs/cirrus-cli) to [smx-smx/cirrus-cli](https://github.com/smx-smx/cirrus-cli)
...
- 🌟 👤 [yuchuangu85](https://github.com/yuchuangu85) Starred [SagerNet/sing-box](https://github.com/SagerNet/sing-box)
  > The universal proxy platform
- 🌟 👤 [yuchuangu85](https://github.com/yuchuangu85) Starred [MetaCubeX/mihomo](https://github.com/MetaCubeX/mihomo)
  > A simple Python Pydantic model for Honkai: Star Rail parsed data from the Mihomo API.
- 🌟 👤 [yuchuangu85](https://github.com/yuchuangu85) Starred [mihomo-party-org/clash-party](https://github.com/mihomo-party-org/clash-party)
  > :electron: Another Mihomo GUI. 

### [zu1k](https://github.com/zu1k)
- 🌟 👤 [zu1k](https://github.com/zu1k) Starred [NVlabs/cuda-oxide](https://github.com/NVlabs/cuda-oxide)
  > cuda-oxide is an experimental Rust-to-CUDA compiler that lets you write (SIMT) GPU kernels in safe(i...
- 🌟 👤 [zu1k](https://github.com/zu1k) Starred [V4bel/dirtyfrag](https://github.com/V4bel/dirtyfrag)


---
*最后更新于 2026-05-08 22:59:52 UTC*
*历史记录保存在 `archive` 目录中。*
