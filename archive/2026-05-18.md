...
- 🌟 👤 [ChiChou](https://github.com/ChiChou) Starred [orinimron123/CVE-2026-40369-EXPLOIT](https://github.com/orinimron123/CVE-2026-40369-EXPLOIT)
...
- 🌟 👤 [divyam234](https://github.com/divyam234) Starred [berberman/nvfetcher](https://github.com/berberman/nvfetcher)
  > Generate nix sources expr for the latest version of packages
- 🌟 👤 [divyam234](https://github.com/divyam234) Starred [j4k0xb/webcrack](https://github.com/j4k0xb/webcrack)
  > Deobfuscate obfuscator.io, unminify and unpack bundled javascript
- 🌟 👤 [divyam234](https://github.com/divyam234) Starred [redf0x1/camofox-browser](https://github.com/redf0x1/camofox-browser)
  > Anti-detection browser server for AI agents — REST API wrapping Camoufox engine with OpenClaw plugin...

### [evilbinary](https://github.com/evilbinary)
- 🌟 👤 [evilbinary](https://github.com/evilbinary) Starred [QuantumNous/new-api](https://github.com/QuantumNous/new-api)
  > A unified AI model hub for aggregation & distribution. It supports cross-converting various LLMs int...
- 🌟 👤 [evilbinary](https://github.com/evilbinary) Starred [Wei-Shaw/sub2api](https://github.com/Wei-Shaw/sub2api)
