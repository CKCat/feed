...
- 🌟 👤 [sekaiacg](https://github.com/sekaiacg) Starred [superturtlee/oneplus_pad3_pro_krnl](https://github.com/superturtlee/oneplus_pad3_pro_krnl)
- 🌟 👤 [sekaiacg](https://github.com/sekaiacg) Starred [superturtlee/kernel-workshop-docker](https://github.com/superturtlee/kernel-workshop-docker)
  > A creative workshop for kernel compiling.
- 🌟 👤 [sekaiacg](https://github.com/sekaiacg) Starred [superturtlee/dkms_android](https://github.com/superturtlee/dkms_android)
- 🌟 👤 [sekaiacg](https://github.com/sekaiacg) Starred [superturtlee/Droidspaces-OSS](https://github.com/superturtlee/Droidspaces-OSS)
  > A lightweight, LXC-like container runtime for Android and Linux. Run full Linux distributions native...
- 🌟 👤 [sekaiacg](https://github.com/sekaiacg) Starred [superturtlee/kernel_manifest](https://github.com/superturtlee/kernel_manifest)
- 🌟 👤 [sekaiacg](https://github.com/sekaiacg) Starred [superturtlee/build_tools](https://github.com/superturtlee/build_tools)
- 🌟 👤 [sekaiacg](https://github.com/sekaiacg) Starred [superturtlee/rust](https://github.com/superturtlee/rust)
- 🌟 👤 [sekaiacg](https://github.com/sekaiacg) Starred [superturtlee/clang](https://github.com/superturtlee/clang)
