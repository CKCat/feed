...
- 🌟 👤 [5ec1cff](https://github.com/5ec1cff) Starred [memtest86plus/memtest86plus](https://github.com/memtest86plus/memtest86plus)
...
- 🌟 👤 [MiroKaku](https://github.com/MiroKaku) Starred [Yu9191/wloc](https://github.com/Yu9191/wloc)
  > 修改 Apple 网络定位（gs-loc）返回坐标 · 支持 Surge / Quantumult X / Loon / Stash · 快捷指令一键设置/恢复定位

### [MlgmXyysd](https://github.com/MlgmXyysd)
- 🌟 👤 [MlgmXyysd](https://github.com/MlgmXyysd) Starred [zchrzhou/mdk-vca-tools](https://github.com/zchrzhou/mdk-vca-tools)
  > Some tools for Intel MSDK on Intel VCA card
- 🌟 👤 [MlgmXyysd](https://github.com/MlgmXyysd) Starred [Lulu-Grant/IntelVCA2](https://github.com/Lulu-Grant/IntelVCA2)
  > Intel VCA2 / Intel Visual Compute Accelerator 2 documentation, deployment guide, compatibility notes...
...
- 🌟 👤 [SeeFlowerX](https://github.com/SeeFlowerX) Starred [Mangi-11/Eta](https://github.com/Mangi-11/Eta)
...
- 🍴 👤 [neocanable](https://github.com/neocanable) Forked [scheatkode/CVE-2018-18955](https://github.com/scheatkode/CVE-2018-18955) to [neocanable/CVE-2018-18955](https://github.com/neocanable/CVE-2018-18955)
  > 💀 Linux local root exploit for CVE-2018-18955
- 🌟 👤 [neocanable](https://github.com/neocanable) Starred [penpot/penpot](https://github.com/penpot/penpot)
  > Penpot: The open-source design platform for Product teams that need scalable collaboration.

### [phodal](https://github.com/phodal)
- 🌟 👤 [phodal](https://github.com/phodal) Starred [anthropic-experimental/sandbox-runtime](https://github.com/anthropic-experimental/sandbox-runtime)
  > A lightweight sandboxing tool for enforcing filesystem and network restrictions on arbitrary process...
- 🌟 👤 [phodal](https://github.com/phodal) Starred [microsoft/vscode-sandbox-runtime](https://github.com/microsoft/vscode-sandbox-runtime)
  > A lightweight sandboxing tool for enforcing filesystem and network restrictions on arbitrary process...
...
- 🌟 👤 [wINfOG](https://github.com/wINfOG) Starred [Lakr233/vphone-cli](https://github.com/Lakr233/vphone-cli)

### [ys1231](https://github.com/ys1231)
- 🌟 👤 [ys1231](https://github.com/ys1231) Starred [9001/copyparty](https://github.com/9001/copyparty)
  > Portable file server with accelerated resumable uploads, dedup, WebDAV, SFTP, FTP, TFTP, zeroconf, m...

### [yuchuangu85](https://github.com/yuchuangu85)
- 🌟 👤 [yuchuangu85](https://github.com/yuchuangu85) Starred [bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book)
  > 《深入理解 AI Agent：设计原理与工程实践》（李博杰 著）开源主仓库：全书正文、编译版 PDF 与按章配套代码
