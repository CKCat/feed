...
- 🌟 👤 [bet4it](https://github.com/bet4it) Starred [UrkeJH/ShizukuDhizuku-list](https://github.com/UrkeJH/ShizukuDhizuku-list)
  > 一个收集支持Shizuku和Dhizuku的软件的项目
- 🌟 👤 [bet4it](https://github.com/bet4it) Starred [timschneeb/awesome-shizuku](https://github.com/timschneeb/awesome-shizuku)
...
- 🍴 👤 [crazyguitar](https://github.com/crazyguitar) Forked [ikostrikov/pytorch-a2c-ppo-acktr-gail](https://github.com/ikostrikov/pytorch-a2c-ppo-acktr-gail) to [crazyguitar/pytorch-a2c-ppo-acktr-gail](https://github.com/crazyguitar/pytorch-a2c-ppo-acktr-gail)
  > PyTorch implementation of Advantage Actor Critic (A2C), Proximal Policy Optimization (PPO), Scalable...
- 🌟 👤 [crazyguitar](https://github.com/crazyguitar) Starred [huggingface/deep-rl-class](https://github.com/huggingface/deep-rl-class)
  > This repo contains the Hugging Face Deep Reinforcement Learning Course.
- 🍴 👤 [crazyguitar](https://github.com/crazyguitar) Forked [huggingface/deep-rl-class](https://github.com/huggingface/deep-rl-class) to [crazyguitar/deep-rl-class](https://github.com/crazyguitar/deep-rl-class)
  > This repo contains the Hugging Face Deep Reinforcement Learning Course.
- 🌟 👤 [crazyguitar](https://github.com/crazyguitar) Starred [Kautenja/nes-py](https://github.com/Kautenja/nes-py)
  > A Python3 NES emulator and OpenAI Gym interface
- 🍴 👤 [crazyguitar](https://github.com/crazyguitar) Forked [Kautenja/nes-py](https://github.com/Kautenja/nes-py) to [crazyguitar/nes-py](https://github.com/crazyguitar/nes-py)
  > A Python3 NES emulator and OpenAI Gym interface
- 🌟 👤 [crazyguitar](https://github.com/crazyguitar) Starred [Kautenja/gym-super-mario-bros](https://github.com/Kautenja/gym-super-mario-bros)
...
- 🌟 👤 [ys1231](https://github.com/ys1231) Starred [HappyIDA/HappyIDA](https://github.com/HappyIDA/HappyIDA)
  > Make You Happy!
- 🌟 👤 [ys1231](https://github.com/ys1231) Starred [junron/auto-enum](https://github.com/junron/auto-enum)
