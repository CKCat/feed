...
- 🌟 👤 [divyam234](https://github.com/divyam234) Starred [nicobailon/visual-explainer](https://github.com/nicobailon/visual-explainer)
  > Agent skill + prompt templates that generate rich HTML pages for visual diff reviews, architecture o...
