...
- 🌟 👤 [divyam234](https://github.com/divyam234) Starred [minitap-ai/mobile-use](https://github.com/minitap-ai/mobile-use)
...
- 🌟 👤 [phodal](https://github.com/phodal) Starred [agent-sh/computer-use-linux](https://github.com/agent-sh/computer-use-linux)
  > Linux desktop control over MCP — AT-SPI, GNOME Shell, Wayland portals, ydotool
- 🌟 👤 [phodal](https://github.com/phodal) Starred [ilysenko/codex-desktop-linux](https://github.com/ilysenko/codex-desktop-linux)
