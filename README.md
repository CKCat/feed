...
- 🌟 👤 [AloneMonkey](https://github.com/AloneMonkey) Starred [sidex15/susfs4ksu-module](https://github.com/sidex15/susfs4ksu-module)
...
- 🌟 👤 [ys1231](https://github.com/ys1231) Starred [Aethersailor/SubConverter-Extended](https://github.com/Aethersailor/SubConverter-Extended)
  > 基于 subconverter 的订阅转换后端增强版：无需拉取远程订阅内容即可完成转换，规避订阅源访问屏蔽；接入 mihomo 原生解析能力并自动跟随上游协议/参数变化，实现完美解析节点链接，同时兼容...
- 🌟 👤 [ys1231](https://github.com/ys1231) Starred [AnInsomniacy/motrix-next](https://github.com/AnInsomniacy/motrix-next)
  > A full-featured download manager — rebuilt from the ground up
- 🌟 👤 [ys1231](https://github.com/ys1231) Starred [KaringX/karing](https://github.com/KaringX/karing)
