...
- 🌟 👤 [evilbinary](https://github.com/evilbinary) Starred [xbtlin/ai-berkshire](https://github.com/xbtlin/ai-berkshire)
  > AI 时代的伯克希尔：基于 Claude Code / Codex 的价值投资研究框架。巴菲特·芒格·段永平·李录四大师方法论 + 多Agent并行研究。| AI-era Berkshire: a v...
- 🍴 👤 [evilbinary](https://github.com/evilbinary) Forked [RightNow-AI/picolm](https://github.com/RightNow-AI/picolm) to [evilbinary/picolm](https://github.com/evilbinary/picolm)
  > Run a 1-billion parameter LLM on a $10 board with 256MB RAM
- 🌟 👤 [evilbinary](https://github.com/evilbinary) Starred [alibaba/MNN](https://github.com/alibaba/MNN)
