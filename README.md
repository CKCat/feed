...
- 🍴 👤 [5ec1cff](https://github.com/5ec1cff) Forked [LuckyPray/DexKit](https://github.com/LuckyPray/DexKit) to [5ec1cff/DexKit](https://github.com/5ec1cff/DexKit)
  > An easy-to-use, high-performance dex deobfuscation library.

### [Haleclipse](https://github.com/Haleclipse)
- 🌟 👤 [Haleclipse](https://github.com/Haleclipse) Starred [KiwiCanopy/KiwiDesk](https://github.com/KiwiCanopy/KiwiDesk)
  > Tiling that feels like it shipped with macOS. Settings instead of config files, seven layouts incl. ...
- 🌟 👤 [Haleclipse](https://github.com/Haleclipse) Starred [appdev/ClipDock](https://github.com/appdev/ClipDock)
  > A local-first clipboard shelf for macOS.在 macOS 上找回、预览、固定并复用剪贴板内容，支持与手机同步、P2P 下载文件
...
- 🌟 👤 [ys1231](https://github.com/ys1231) Starred [Seyud/device_faker](https://github.com/Seyud/device_faker)
  > 自定义配置Zygisk机型伪装
