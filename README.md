...
- 🌟 👤 [0xbinder](https://github.com/0xbinder) Starred [CakesTwix/Android-CVE-2026-43499](https://github.com/CakesTwix/Android-CVE-2026-43499)
  > Android version CVE-2026-43499 tester

### [19h](https://github.com/19h)
- 🍴 👤 [19h](https://github.com/19h) Forked [facebook/zstd](https://github.com/facebook/zstd) to [19h/zstd](https://github.com/19h/zstd)
  > Zstandard - Fast real-time compression algorithm

### [5ec1cff](https://github.com/5ec1cff)
- 🍴 👤 [5ec1cff](https://github.com/5ec1cff) Forked [adamcrume/java-properties](https://github.com/adamcrume/java-properties) to [KernelSU2/java-properties](https://github.com/KernelSU2/java-properties)
  > A library for reading and writing Java properties files in Rust
- 🍴 👤 [5ec1cff](https://github.com/5ec1cff) Forked [cocool97/adb_client](https://github.com/cocool97/adb_client) to [KernelSU2/adb_client](https://github.com/KernelSU2/adb_client)
  > Rust & Python ADB (Android Debug Bridge) client library
- 🍴 👤 [5ec1cff](https://github.com/5ec1cff) Forked [bytecodealliance/rustix](https://github.com/bytecodealliance/rustix) to [KernelSU2/rustix](https://github.com/KernelSU2/rustix)
  > Safe Rust bindings to POSIX-ish APIs
- 🍴 👤 [5ec1cff](https://github.com/5ec1cff) Forked [matzefriedrich/zip-extensions-rs](https://github.com/matzefriedrich/zip-extensions-rs) to [KernelSU2/zip-extensions-rs](https://github.com/KernelSU2/zip-extensions-rs)
  > Provides extensions for the zip crate
- 🍴 👤 [5ec1cff](https://github.com/5ec1cff) Forked [syntaxseed/terminalfaker](https://github.com/syntaxseed/terminalfaker) to [KernelSU2/ksu_exam_legacy](https://github.com/KernelSU2/ksu_exam_legacy)
  > Terminal Faker - A client-side Linux-like cli terminal simulation written in Javascript. Originally ...
- 🍴 👤 [5ec1cff](https://github.com/5ec1cff) Forked [osm0sis/AnyKernel3](https://github.com/osm0sis/AnyKernel3) to [KernelSU2/AnyKernel3](https://github.com/KernelSU2/AnyKernel3)
  > AnyKernel, Evolved
- 🍴 👤 [5ec1cff](https://github.com/5ec1cff) Forked [tiann/loopdev](https://github.com/tiann/loopdev) to [KernelSU2/loopdev](https://github.com/KernelSU2/loopdev)
  > A rust library to setup and control loopback devices
- 🍴 👤 [5ec1cff](https://github.com/5ec1cff) Forked [ben-z/actions-comment-on-issue](https://github.com/ben-z/actions-comment-on-issue) to [KernelSU2/actions-comment-on-issue](https://github.com/KernelSU2/actions-comment-on-issue)
  > GitHub action to comment on issues
- 🍴 👤 [5ec1cff](https://github.com/5ec1cff) Forked [5ec1cff/resetprop-rs](https://github.com/5ec1cff/resetprop-rs) to [KernelSU2/ksu_props](https://github.com/KernelSU2/ksu_props)
- 🍴 👤 [5ec1cff](https://github.com/5ec1cff) Forked [rustls/webpki](https://github.com/rustls/webpki) to [KernelSU2/webpki](https://github.com/KernelSU2/webpki)
  > WebPKI X.509 Certificate Validation in Rust

### [Admirepowered](https://github.com/Admirepowered)
- 🚀 👤 [Admirepowered](https://github.com/Admirepowered) Made [AndroidPatch/restprops](https://github.com/AndroidPatch/restprops) public
  > upstream: https://github.com/Kernel-SU/ksu_props

### [Mufanc](https://github.com/Mufanc)
- 🌟 👤 [Mufanc](https://github.com/Mufanc) Starred [letta-ai/letta-code](https://github.com/letta-ai/letta-code)
...
- 🌟 👤 [hackcatml](https://github.com/hackcatml) Starred [blazux/qwen3.8-Flash-DGX](https://github.com/blazux/qwen3.8-Flash-DGX)
...
- 🌟 👤 [phodal](https://github.com/phodal) Starred [charmbracelet/bubbletea](https://github.com/charmbracelet/bubbletea)
  > A powerful little TUI framework 🏗

### [sin5678](https://github.com/sin5678)
- 🌟 👤 [sin5678](https://github.com/sin5678) Starred [LeoChen-CoreMind/VMPacker](https://github.com/LeoChen-CoreMind/VMPacker)
  > ARM64 ELF Virtual Machine Protection System

### [veritas501](https://github.com/veritas501)
- 🌟 👤 [veritas501](https://github.com/veritas501) Starred [KHwang9883/MobileModels](https://github.com/KHwang9883/MobileModels)
  > 手机品牌型号汇总 | Mobile Models | This repository is licensed under CC BY-NC-SA 4.0
- 🌟 👤 [veritas501](https://github.com/veritas501) Starred [MG1937/ASC](https://github.com/MG1937/ASC)
