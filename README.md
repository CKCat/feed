...
- 🌟 👤 [MouriNaruto](https://github.com/MouriNaruto) Starred [zeroclaw-labs/zeroclaw](https://github.com/zeroclaw-labs/zeroclaw)
  > Fast, small, and fully autonomous AI assistant infrastructure — deploy anywhere, swap anything 🦀
- 🌟 👤 [MouriNaruto](https://github.com/MouriNaruto) Starred [opencode-ai/opencode](https://github.com/opencode-ai/opencode)
  > A powerful AI coding agent. Built for the terminal.
- 🌟 👤 [MouriNaruto](https://github.com/MouriNaruto) Starred [charmbracelet/crush](https://github.com/charmbracelet/crush)
...
- 🌟 👤 [evilbinary](https://github.com/evilbinary) Starred [memovai/mimiclaw](https://github.com/memovai/mimiclaw)
