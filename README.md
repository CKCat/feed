...
- 🌟 👤 [gatieme](https://github.com/gatieme) Starred [opencode-ai/opencode](https://github.com/opencode-ai/opencode)
  > A powerful AI coding agent. Built for the terminal.
- 🌟 👤 [gatieme](https://github.com/gatieme) Starred [badlogic/pi-mono](https://github.com/badlogic/pi-mono)
  > AI agent toolkit: coding agent CLI, unified LLM API, TUI & web UI libraries, Slack bot, vLLM pods
- 🌟 👤 [gatieme](https://github.com/gatieme) Starred [badlogic/pi-skills](https://github.com/badlogic/pi-skills)
