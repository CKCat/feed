...
- 🌟 👤 [nzcv](https://github.com/nzcv) Starred [AutoCodeStack/ios-device-farm](https://github.com/AutoCodeStack/ios-device-farm)
  > a device farm to control iPhone devices manually using web
- 🌟 👤 [nzcv](https://github.com/nzcv) Starred [DeNA/devfarm](https://github.com/DeNA/devfarm)
