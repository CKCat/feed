...
- 🌟 👤 [ErodedElk](https://github.com/ErodedElk) Starred [calesthio/Crucix](https://github.com/calesthio/Crucix)
  > Your personal intelligence agent. Watches the world from multiple data sources and pings you when so...

### [MiroKaku](https://github.com/MiroKaku)
- 🌟 👤 [MiroKaku](https://github.com/MiroKaku) Starred [jorgebucaran/hydro](https://github.com/jorgebucaran/hydro)
  > Ultra-pure, lag-free prompt with async Git status—just for Fish
- 🌟 👤 [MiroKaku](https://github.com/MiroKaku) Starred [starship/starship](https://github.com/starship/starship)
  > ☄🌌️  The minimal, blazing-fast, and infinitely customizable prompt for any shell!

### [MouriNaruto](https://github.com/MouriNaruto)
- 🌟 👤 [MouriNaruto](https://github.com/MouriNaruto) Starred [mganss/XmlSchemaClassGenerator](https://github.com/mganss/XmlSchemaClassGenerator)
...
- 🌟 👤 [gatieme](https://github.com/gatieme) Starred [kaansenol5/VibeOS](https://github.com/kaansenol5/VibeOS)
  > A completely vibecoded operating system targeting Aarch64
- 🌟 👤 [gatieme](https://github.com/gatieme) Starred [Gen-Verse/LatentMAS](https://github.com/Gen-Verse/LatentMAS)
  > [ICML 2026 Spotlight] Latent Collaboration in Multi-Agent Systems
- 🌟 👤 [gatieme](https://github.com/gatieme) Starred [rothgar/awesome-tuis](https://github.com/rothgar/awesome-tuis)
...
- 🌟 👤 [hackcatml](https://github.com/hackcatml) Starred [vercel-labs/skills](https://github.com/vercel-labs/skills)
  > The open agent skills tool - npx skills

### [jonpalmisc](https://github.com/jonpalmisc)
- 🌟 👤 [jonpalmisc](https://github.com/jonpalmisc) Starred [rusterlium/rustler](https://github.com/rusterlium/rustler)
  > Safe Rust bridge for creating Erlang NIF functions
- 🌟 👤 [jonpalmisc](https://github.com/jonpalmisc) Starred [erlang/otp](https://github.com/erlang/otp)
  > Erlang/OTP
...
- 🌟 👤 [ys1231](https://github.com/ys1231) Starred [jiqiu2022/vm-trace-release](https://github.com/jiqiu2022/vm-trace-release)
  > vmtrace的发布仓库，相关so 调用脚本例子都会放在里面


---
*最后更新于 2026-05-06 23:46:15 UTC*
*历史记录保存在 `archive` 目录中。*
